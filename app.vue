    ...
    <header role="banner">
      ...
      <p>
        ...
        <a
          ...
          >normalize</a
        >
        using Open Props! Minimal styles for all HTML elements. Plus, it's
        adaptive to light and dark. The props are made available for you to
        continue building
      ...
      <div>
        ...
        <p>
          Great for cards, buttons, borders, sidenavs, wells, etc. When you want
          to change the perception of layering and grouping.
        </p>
      ...
      <div class="text-samples">
        ...
        <h5 class="contrast">
          <span class="swatch contrast"></span>
          var(--contrast)
        </h5>
        <h5 class="text1">
        ...
        <h5 class="text2">
          <span class="swatch system-green"></span>
          var(--system-green)
        </h5>
        <h5 class="text2">
          <span class="swatch system-yellow"></span>
          var(--system-yellow)
        </h5>
        <h5 class="text2">
          <span class="swatch system-red"></span>
          var(--system-red)
        </h5>
        <p>
          Using these props results in colors that adapt to the users system
          theme preference automatically.
        </p>
        <p>
          The brand color is used sparingly, find it used in the HTML elements
          below! The link color is useful for buttons and other custom
          components you want to have consistent interactive text for.
        </p>
      </div>
      <hr />
