      ...
      <div class="footer-column">
        ...
        <ul>
          <li class="flex flex-gap-1">
            <NuxtLink to="https://www.facebook.com/TINC.SHOP" target="_blank"
              ><img src="/icons/facebook.svg" alt="facebook" /></NuxtLink
            ><NuxtLink to="https://www.instagram.com/tinc.shop/" target="_blank"
